...
<table>
    ...
    <tbody >
        <tr>
            ...
            <td style="vertical-align: middle;text-align:center;border: 0.5px solid rgba(0,0,0,0.2);"> Brainstorm</td>
            <td>Must</td>
        </tr>
        <tr>
            ...
            <td style="vertical-align: middle;text-align:center;border: 0.5px solid rgba(0,0,0,0.2);">Brainstorm, Introspecção </td>
            <td>Must</td>
        </tr>
        <tr>
